...
//	y=y-WIN_HEIGHT;
	CreateEx(WS_EX_TOPMOST,
			 ...
			 AfxGetMainWnd()->GetSafeHwnd(),//AfxGetMainWnd()->GetSafeHwnd(),
			 NULL,
			 NULL);
...
{
	ShellExecute(this->GetSafeHwnd(),"open","C:\\Program Files\\Outlook Express\\msimn.exe",NULL,NULL,SW_SHOW); 	
	//ShellExecute(this->GetSafeHwnd(),"open","%ProgramFiles%\\Outlook Express\\msimn.exe",NULL,NULL,SW_SHOW); 
	//WinExec("%ProgramFiles%\\Outlook Express\\msimn.exe 2",SW_SHOW);
	SetTimer(ID_TIMER_DISPLAY_DELAY,3000,NULL);
